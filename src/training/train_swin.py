...
# Model
class SwinTransformerV2Detector(nn.Module):
    def __init__(self):
        super().__init__()
...
def main():
    print("=" * 70)
    print("Swin Transformer V2 Training")
    print("=" * 70)
    ...
    # Build model
    print("\nBuilding model...")
    model = SwinTransformerV2Detector().to(device)
    ...
    with open('swin_v2_summary.json', 'w') as f:
        json.dump(summary, f, indent=2)
    
    print("\nOutput files:")
    print("  swin_v2_best.pth")
    print("  swin_v2_summary.json")
